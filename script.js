...
function clickContactBtn(e) { // e - MouseEvent object;
    console.log(e);
}
...
const BORDER_COLOR = '#112';
// const BORDER_COLOR = '#13191f';
const CELL_HIGHLIGHT = '#328bf6';
const ELECTRON_COLOR = '#00FF00';
// const ELECTRON_COLOR = '#00b07c';
const FONT_COLOR = '#11dd11';
// const FONT_COLOR = '#438d20';
